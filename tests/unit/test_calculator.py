...
@pytest.mark.parametrize(
    "a, b, expected",
    [
        (5, 3, 2),           # Test modulus of two positive integers
        (-5, 3, 1),         # Test modulus of a negative integer with a positive integer
        (5.5, 2.0, 1.5),    # Test modulus of two positive floats
        (-5.5, 2.0, 0.5),   # Test modulus of a negative float with a positive float
        (0, 5, 0),          # Test modulus of zero with a positive integer
    ],
    ids=[
        "modulus_two_positive_integers",
        "modulus_negative_and_positive_integer",
        "modulus_two_positive_floats",
        "modulus_negative_float_and_positive_float",
        "modulus_zero_and_positive_integer",
    ]
)
def test_modulus(a: Number, b: Number, expected: Number) -> None:
    ...
    This parameterized test verifies that the 'modulus' function correctly computes the
    modulus of the first number by the second, handling both positive and negative values,
